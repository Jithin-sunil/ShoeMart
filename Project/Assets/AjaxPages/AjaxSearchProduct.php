...
include("../Connection/Connection.php");
    ...
    if (isset($_GET["action"])) {
        ...
        $sqlQry = "SELECT * from tbl_product p inner join tbl_brand b on b.brand_id=p.brand_id 
		inner join tbl_color c on c.color_id=p.color_id 
		inner join tbl_size s on s.size_id=p.size_id 
		inner join tbl_category ca on ca.category_id=p.category_id  
		inner join tbl_shop k on k.shop_id=p.shop_id where true ";
        ...
        if ($_GET["brand"]!=null) {
            ...
            $sqlQry = $sqlQry." AND sc.brand_id IN(".$brand.")";
        }
		if ($_GET["size"]!=null) {

            $size = $_GET["size"];

            $sqlQry = $sqlQry." AND sc.size_id IN(".$size.")";
        }
		if ($_GET["color"]!=null) {

            $color = $_GET["color"];

            $sqlQry = $sqlQry." AND sc.color_id IN(".$color.")";
        }
