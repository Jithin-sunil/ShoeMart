        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <ul class="list-group">
                        <?php                           
						 $selcolor = "SELECT * from tbl_color";
                            $result = $con->query($selcolor);
                            while ($row=$result->fetch_assoc()) {
                        ?>
                        <li class="list-group-item">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" onclick="changeSub(),productCheck()" class="form-check-input product_check" value="<?php echo $row["color_id"]; ?>" id="color"><?php echo $row["color_name"]; ?>
                                </label>
                            </div>
                        </li>
                        <?php
                    ...
                    <ul class="list-group">
                        <?php                           
						 $selsize = "SELECT * from tbl_size";
                            $result = $con->query($selsize);
                            while ($row=$result->fetch_assoc()) {
                        ?>
                        <li class="list-group-item">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" onclick="changeSub(),productCheck()" class="form-check-input product_check" value="<?php echo $row["size_id"]; ?>" id="size"><?php echo $row["size_name"]; ?>
                                </label>
                            </div>
                        </li>
                        <?php
