                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                                class="fa fa-laptop me-2"></i>Basic Data</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="Brand.php" class="dropdown-item">Brand</a>
                            <a href="Category.php" class="dropdown-item">Category</a>
                            <a href="Color.php" class="dropdown-item">Color</a>
                            <a href="Size.php" class="dropdown-item">Size</a>
                            <a href="District.php" class="dropdown-item">District</a>
                            <a href="Place.php" class="dropdown-item">Place</a>

                        </div>
                    </div>
                    <a href="ViewComplaint.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>View
                        Complaints</a>

                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                                class="far fa-file-alt me-2"></i>New Shop</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="NewShop.php" class="dropdown-item">New Shops</a>
                            <a href="VerifiedShop.php" class="dropdown-item">Verified Shop</a>
                            <a href="RejectedShop.php" class="dropdown-item">Rejected Shop</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="../Assets/Template/Admin/img/user.jpg" alt=""
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="../Assets/Template/Admin/img/user.jpg" alt=""
                                style="width: 40px; height: 40px;">
