<?php
  ...
  session_start();
    ...
    $da=$_POST["txt_address"];    
	  $insqry="INSERT INTO tbl_shop(shop_name,shop_contact,shop_email,place_id,shop_password,shop_image,shop_address,shop_proof)
     values('$name','$contact','$email','$place','$password','$photo','$da','$proof')";
      if($con->query($insqry))
       {
